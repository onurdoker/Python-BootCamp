...
# ! Fifth Example
# Dictionary
# student = ["Ali", 22, "Computer Engineering", 85]
...
# vehicle = {"brand": "Toyota", "model": "Corolla", "year": 2020, "color": "red"}
...
# for key, value in zip(eng_tr.keys(), eng_tr.values()):
#     print(key, "=>", value)
