...
# print("Response Code: ", response.status_code)  # Response Code:  200
...
#     print(
#         f"Time to fetch data from the API: {(finish - start).total_seconds():.3f} seconds\n"
#     )
...
#                 print(
#                     f"✅ {crypto_name.capitalize()}: ${usd:,.2f} | ₺{try_price:,.0f} "
#                 )
#             else:
...
# while True:
#     coin = input(
#         "Enter the name of the cryptocurrency you would like to use (press 'q' to quit): "
#     )
#     if coin.lower() == "q":
#         print("Exiting...")
#         break
