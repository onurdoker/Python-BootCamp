...
#
# student2 = DepartmentStudent("James",
#                              "Johnson",
#                              "Math")
...
#         self.spot = "offence"
#
# class Multi_Player(Football_Player,
#                    Basketball_Player):
#     def __init__(self,
#                  foot):
#         Basketball_Player.__init__(self)
#         Football_Player.__init__(self,
#                                  foot)
#
# John = Multi_Player("left")
# print("Vault:",
#       John.vault)
# print("Is John runnable ",
#       John.running)
# print("John's salary is ",
#       John.salary)
...
#
#     def fullname(self):
#         return 'Name: {} surname: {}'.format(self.name,
#                                              self.surname)
#
#     def increase(self):
...
#                      1950)
#
# developer1 = Developer("Black",
#                        "Jack",
#                        2500,
#                        "Python")
#
# manager1 = Manager("Eric",
#                    "Match",
#                    4000,
#                    [employee1,
#                     developer1])
...
#                  Employee))  # True
#
# print(issubclass(Employee,
#                  Developer))  # False
# print(issubclass(Developer,
#                  Employee))  # True
...
#
# print(f"Model: {car_object.brand} and color: {car_object.color}")  # Model: BMW and color: blue
#
# car_object.color = "red"  # The color was changed from outside
# print(f"Model: {car_object.brand} and color: {car_object.color}")  # Model: BMW and color: red
...
#     print(f"\n[ERROR] Direct Access Blocked {error} ")  # [ERROR] Direct Access Blocked 'User' object has no attribute '__password'
...
# print(f"\nAccessing via Name Mangling: {user1._User__password}")  # Accessing via Name Mangling: secret123
...
#         return "Athlete name: {}, Field: {}".format(athlete1.name,
#                                                     athlete1.field)
#
#     @property
#     def a_print(self):
...
# print("Number of bronze medal: ",
#       athlete1.mbronze)
"""
Number of bronze medal:  9
"""

# print("Number of silver medal: ",
#       athlete1._msilver)
"""
