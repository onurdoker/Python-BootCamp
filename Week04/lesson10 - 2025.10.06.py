...
# def student_create(name, age, average):
#     return {"name": name, "age": age, "average": average}


# def student_info(student):
#     return (
#         f"{student['name']}, {student['age']} years old, {student['average']} average"
#     )


# student = student_create("Onur", 48, 3.7)
# print(student_info(student))


# ! Second Example
# def student_info_update(student, **kwargs):
...
# student_info_update(student, age=38)
# print(student_info(student))
...
# student1 = Student("Onur", 48, 3.7)

# print(student1.student_info())

# student2 = Student("Timur", 57, 3.9)
...
# print(student1.name, type(student1.name))
...
# print("Student2: ", student2.name, student2.surname)
...
# print("Number of wheel: ", Car.wheel_number)
# print("General usage of Student.course: ", Student.course)

# student1 = Student()
# print("Course of student1:", student1.course)
# student1.faculty = "Chemical Engineering"
# print("Student1's Faculty: ", student1.faculty)
# print("Student's Faculty: ", Student.faculty)
...
# print("Book's name:", book1.name)

# variables = vars(book1)
# print("Variables of books: ", variables, "\nType of book: ", type(variables))
...
# print("Car1's wheel number: ", car1.wheel_number)
# print("Car1's brand and model: ", car1.brand, car1.model)
# car2 = Car("Renault", "Megane 3")
# print("Car2's wheel number: ", car2.wheel_number)
# print("Car2's brand and model: ", car2.brand, car2.model)
# car3 = Car(model="Civic", brand="Honda")
# print("Car3's wheel number: ", car3.wheel_number)
# print("Car3's brand and model: ", car3.brand, car3.model)
...
# student1 = Student()
# print("Department of Student1: ", student1.department)
...
# print("Department and Building of Student: ", Student.department, Student.building)
...
# student1 = Student("Onur", "DOKER", 32232234)
# print("Department of Student1: ", student1.department)
# print("Name of Student1: ", student1.name)
...
# print("Name of Student1: ", student1.name)
# student1.fullname()
# print("Full name of Student1: ", student1.fullname)
...
# print(Mathematics.multiply(5, 2))
...
# # Adding students
# student1 = Student("James", "Smith", 90)
# student2 = Student("Damla", "ALKAN", 100)
# student3 = Student("Onur", "DOKER", 90)
...
#     @classmethod
#     def shared_velocity(cls, amount):
#         cls.velocity += amount
...
# customer = Bill("Damla", 123456, 2024)
...
# # Adding books
# book1 = Book("123456", "Python Programming", "Ahmet Emin", 350, 2023)
