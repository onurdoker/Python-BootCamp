...
#     ("The Lords of the Rings", "Tolkien"),
# )
...
# * Adding book
# book1 = Book(name="Think Python", author="O'Riley")

# session.add(book1)
# session.commit()

# * Adding multidata
# book2 = Book(name="C#", author="Mustafa Hoca")
# book3 = Book(name="JavaScript Lessons", author="O'Riley")
