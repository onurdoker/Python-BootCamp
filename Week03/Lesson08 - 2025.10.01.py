...
#       math.sqrt(16))
#
# print('Round the number: ',
#       round(4.501))
#
# print('Calculating cos an angle: ',
#       math.cos(math.radians(90)))

# ! Fourth Example
# import random  # * random library
#
# print('random a number between 0 - 1: ',
#       random.random())  # * random float number between 0 and 1
#
# print('random a number between 0 - 100: ',
#       random.randint(1,
#                      100))  # * random integer number between 1 and 100
#
# print('random a float number between 1 - 5: ',
#       random.uniform(1,
#                      5))  # * random float number between 1 and 5
#
# colors = ['red',
#           'yellow',
#           'pink']
...
# print('Date: ',
#       now_.date())
# print('Which day of week: ',
#       now_.weekday())
# print('Which day of week: ',
#       now_.strftime('%A'))
# print('Which mount: ',
#       now_.strftime('%B'))
# print('Which day of mount: ',
#       now_.strftime('%d'))
# print('Format of time: ',
#       now_.strftime('%d/%m/%Y'))
# print('Hour format: ',
#       now_.strftime('%H:%M:%S'))
# print('Week Day: ',
#       now_.strftime('%A').replace('Wednesday',
#                                   'Carsamba'))  # to change the day name
# print('Month: ',
#       now_.strftime('%B').replace('October',
#                                   'Kasim'))
...
#     circle_area = math.pi * math.pow(radius,
#                                      2)
...
#     power_ = math.pow(radius,
#                       2)
#     cube = math.pow(radius,
#                     3)
...
#
# data = {'name': 'Ali', 'age': 30, 'cities': ['Istanbul',
#                                              'Ankara',
#                                              'Izmir']}
# print(data)
